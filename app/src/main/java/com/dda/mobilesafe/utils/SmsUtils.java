...
//            pd.setMax(count);
            ...
            try {
                ...
                //得到序列化器
                //在安卓系统里面所有有关xml的解析都是pull解析
                XmlSerializer serializer = Xml.newSerializer();
                //把短信序列化到sd卡然后设置编码格式
                serializer.setOutput(os, "utf-8");
                //standalone表示当前的xml是否是独立文件 true，表示文件独立
                serializer.startDocument("utf-8", true);
                //设置开始的节点是一个参数是命名空间，第二个参数是节点的名字
