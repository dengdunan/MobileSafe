...
import com.dda.mobilesafe.adapter.MyBaseAdapter;
...
public class CallSafeActivity extends Activity {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                if (blackNumberInfos == null) {
                    ...
                    //把后面的数据。追加到blackNumberInfos集合里面。防止黑名单中的数据被覆盖
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(adapter == null){
                    ...
                    adapter.notifyDataSetChanged();//通知数据进行改变
                }
    ...
    private void initUI() {
        ...
        list_view.setOnScrollListener(new AbsListView.OnScrollListener() {
             ...
             *
             *                     AbsListView.OnScrollListener.SCROLL_STATE_IDLE 闲置状态,静止状态
